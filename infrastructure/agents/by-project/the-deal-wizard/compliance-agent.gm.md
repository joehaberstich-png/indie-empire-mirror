# 🏆 Grandmaster Agent: The Deal Wizard — Compliance/Legal
...
## Deploy Targets
```
- Production: https://the-deal-wizard.vercel.app
- CS Bot: site/the-deal-wizard/js/quantum-cs-v2.js
```
