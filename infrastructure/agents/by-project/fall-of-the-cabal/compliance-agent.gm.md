# 🏆 Grandmaster Agent: Fall of the Cabal — Compliance/Legal
...
## Deploy Targets
```
- Production: https://fall-of-the-cabal.vercel.app
- CS Bot: site/fall-of-the-cabal/js/quantum-cs-v2.js
```
