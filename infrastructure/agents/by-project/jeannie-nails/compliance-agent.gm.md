# 🏆 Grandmaster Agent: Jeannie Nails — Compliance/Legal
...
## Deploy Targets
```
- Production: https://jeannie-nails.vercel.app
- CS Bot: site/jeannie-nails/js/quantum-cs-v2.js
```
