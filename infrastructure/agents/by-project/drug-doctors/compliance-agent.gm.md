# 🏆 Grandmaster Agent: Drug Doctors — Compliance/Legal
...
## Deploy Targets
```
- Production: https://drug-doctors.vercel.app
- CS Bot: site/drug-doctors/js/quantum-cs-v2.js
```
