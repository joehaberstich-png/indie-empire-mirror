# 🏆 Grandmaster Agent: Fly To Australia — Compliance/Legal
...
## Deploy Targets
```
- Production: https://fly-to-australia.vercel.app
- CS Bot: site/fly-to-australia/js/quantum-cs-v2.js
```
